...
class ApiClient implements ApiService {
  ...
  Future<Map<String, dynamic>> get(String endpoint) async {
    ...
    try {
      ...
      _handleRequestError(endpoint, error, stackTrace);
      rethrow;
    }
  }
  ...
  void _handleRequestError(String endpoint, dynamic error, StackTrace? stackTrace) {
    // Log to console for debugging
    debugPrint('ApiClient: Request to $endpoint failed: $error');
    if (stackTrace != null) {
      debugPrint('Stack trace: $stackTrace');
    }

    // Track via network monitor
