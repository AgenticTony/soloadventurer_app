...
/// including trips, itineraries, journals, users, and synchronization queue.
///
...
///
/// **Database Version**: 1
/// **Tables**: Trips, Itineraries, ItineraryItems, Journals, Users, SyncQueue, SyncMetadata
///
/// Example usage:
/// ```dart
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<Map<String, dynamic>> getDatabaseInfo() async {
    try {
      ...
      debugPrint('Database.getDatabaseInfo failed: $e');
  ...
  Future<void> deleteDatabaseFile() async {
    try {
      ...
      // Log errors during deletion but don't throw
      // File might not exist or permissions might prevent deletion
      debugPrint('Database.deleteDatabaseFile failed: $e');
      debugPrint('Stack trace: $stackTrace');
    }
  }
}
