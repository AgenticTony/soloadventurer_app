...
class DatabaseService {
  ...
  Future<Map<String, dynamic>> getDatabaseInfo() async {
    final info = await _getDatabaseInfoStatic();
    return {
      ...info,
  ...
  /// Internal helper to get database info without an instance
  Future<Map<String, dynamic>> _getDatabaseInfoStatic() async {
    try {
      final dbDir = await getApplicationDocumentsDirectory();
      final dbPath = p.join(dbDir.path, AppDatabase.dbName);
  ...
  /// Internal helper to delete the database file
