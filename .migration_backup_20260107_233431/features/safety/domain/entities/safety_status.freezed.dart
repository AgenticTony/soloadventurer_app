...
mixin _$SafetyStatus {
  ...
  @override
  String toString() {
    return 'SafetyStatus(id: $id, userId: $userId, statusType: $statusType, message: $message, location: $location, batteryLevel: $batteryLevel, timestamp: $timestamp, updatedAt: $updatedAt, safetyAlertId: $safetyAlertId, checkInId: $checkInId, metadata: $metadata)';
  }
}
...
/// @nodoc
@JsonSerializable()
class _SafetyStatus extends SafetyStatus {
  const _SafetyStatus(
      {required this.id,
...
/// @nodoc
@JsonSerializable()
class _SafetyStatusLocation extends SafetyStatusLocation {
