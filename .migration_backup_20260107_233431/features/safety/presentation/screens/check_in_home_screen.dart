  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: checkInAsync.when(
        ...
        data: (checkInData) {
          final upcomingCheckIns = checkInData.upcomingCheckIns;
          final nextCheckIn = checkInData.nextCheckIn;
          final dueSoonCount = checkInData.dueSoonCount;
          final missedCount = checkInData.missedCount;
