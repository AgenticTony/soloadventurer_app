      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            Icon(
              Icons.block,
              color: isSkipped ? Colors.grey : Colors.grey.withOpacity(0.6),
              size: 28,
            ),
            const SizedBox(width: 16),
            Expanded(
...
class BudgetSelectionCompact extends StatelessWidget {
  ...
  Widget _buildSkipChip(BuildContext context) {
    ...
    return FilterChip(
      ...
      backgroundColor: theme.colorScheme.surface,
      side: BorderSide(
        color: isSkipped ? Colors.grey : theme.colorScheme.outline.withOpacity(0.5),
      ),
      visualDensity: VisualDensity.compact,
    );
  }
