...
enum OperationPriority {
  ...
  /// Create OperationPriority from integer value
  ///
  /// Returns the matching enum value for the given integer priority.
  /// Defaults to [OperationPriority.normal] if no match is found.
  static OperationPriority fromValue(int value) {
    return OperationPriority.values.firstWhere(
      (e) => e.value == value,
...
/// JsonConverter for OperationPriority enum
///
/// Handles serialization and deserialization of OperationPriority enum
/// to/from JSON. The enum is stored as an integer value in JSON.
///
/// Example:
/// ```dart
/// @freezed
/// class MyOperation with _$MyOperation {
///   const factory MyOperation({
///     @OperationPriorityConverter() required OperationPriority priority,
///   }) = _MyOperation;
/// }
/// ```
class OperationPriorityConverter implements JsonConverter<OperationPriority, int> {
  const OperationPriorityConverter();

  @override
  OperationPriority fromJson(int json) => OperationPriority.fromValue(json);

  @override
  int toJson(OperationPriority object) => object.value;
}
