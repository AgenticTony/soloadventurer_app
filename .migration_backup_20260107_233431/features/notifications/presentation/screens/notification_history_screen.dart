...
class NotificationHistoryScreen extends ConsumerWidget {
  ...
  Widget? _buildTrailing(
    ...
    return IconButton(
      icon: const Icon(Icons.delete_outline),
      onPressed: () async {
        await ref.read(notificationsNotifierProvider.notifier).dismiss(notification.id);
      },
      tooltip: 'Dismiss',
    );
  }
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              await ref.read(notificationsNotifierProvider.notifier).clearHistory();
            },
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow('Scheduled',
                DateFormat('MMM d, yyyy HH:mm').format(notification.scheduledAt)),
            if (notification.deliveredAt != null)
              _buildDetailRow('Delivered',
                  DateFormat('MMM d, yyyy HH:mm').format(notification.deliveredAt!)),
