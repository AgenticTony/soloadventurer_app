...
export 'package:soloadventurer/features/travel/presentation/widgets/add_itinerary_item_modal.dart' show ActivityType;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: switch (itineraryAsync) {
        ...
        AsyncError(:final error) => _buildErrorView(context, ref, error.toString()),
      },
