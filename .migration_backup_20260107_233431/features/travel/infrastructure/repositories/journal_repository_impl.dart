...
debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to read journal from local cache');
    }
  }
  ...
  Future<LocalJournalModel> writeToLocal(LocalJournalModel model) async {
    try {
      ...
      debugPrint('Error writing journal: $e');
      throw const CacheException(message: 'Failed to write journal to local cache');
    }
  }
  ...
  Future<void> deleteFromLocal(String id) async {
    try {
      ...
      debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to delete journal from local cache');
    }
  }
...
debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to read journals from local cache');
    }
  }
...
debugPrint('Error: $e');
      ...
      throw const ServerException(message: 'Failed to create journal on server');
    }
  }
...
debugPrint('Error: $e');
      ...
      throw const ServerException(message: 'Failed to update journal on server');
    }
  }
  ...
  Future<void> executeRemoteDelete(String id) async {
    try {
      ...
      throw const ServerException(message: 'Failed to delete journal on server');
    }
  }
...
debugPrint('Error: $e');
      ...
      throw const ServerException(message: 'Failed to fetch journal from server');
    }
  }
...
debugPrint('Error: $e');
      ...
      throw const ServerException(message: 'Failed to fetch journals from server');
    }
  }
    ...
    try {
      ...
      for (final entity in journals) {
        ...
        try {
          ...
          debugPrint('journal: Failed to cache journal: $e');
        }
      }
...
debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to get journals by date range');
    }
  }
