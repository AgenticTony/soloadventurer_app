...
class TripRepositoryImpl extends OfflineAwareRepository<Trip, LocalTripModel,
  ...
  Future<LocalTripModel?> readFromLocal(String id) async {
    try {
      ...
      debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to read trip from local cache');
    }
  }
  ...
  Future<LocalTripModel> writeToLocal(LocalTripModel model) async {
    try {
      ...
      debugPrint('Error writing trip: $e');
      throw const CacheException(message: 'Failed to write trip to local cache');
    }
  }
  ...
  Future<void> deleteFromLocal(String id) async {
    try {
      ...
      debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to delete trip from local cache');
    }
  }
  ...
  Future<List<LocalTripModel>> readAllFromLocal({String? userId}) async {
    try {
      ...
      debugPrint('Error: $e');
      throw const CacheException(message: 'Failed to read trips from local cache');
    }
  }
