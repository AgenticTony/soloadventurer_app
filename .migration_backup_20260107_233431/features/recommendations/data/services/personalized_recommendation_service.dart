...
class PersonalizedRecommendationService implements RecommendationService {
  ...
  Future<double> _calculateRelevanceScore({
    ...
    final hasGoodWeather = weatherByDate.values.any((forecasts) =>
      forecasts.any((w) => w.isGoodForOutdoors)
    );
    ...
    return PersonalizedRecommendation(
      ...
      metadata: RecommendationMetadata(
        ...
        estimatedCost: place.cost != null
            ? Money(amount: place.cost!, currency: _getCurrency(request.destination))
            : null,
  ...
  RecommendationCategory _interestToCategory(TravelInterest interest) {
    switch (interest) {
      ...
      case TravelInterest.entertainment:
