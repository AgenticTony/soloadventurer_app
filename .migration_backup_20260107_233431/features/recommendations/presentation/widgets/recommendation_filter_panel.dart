        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => onFilterChanged(RecommendationFilter.defaultFilter()),
...
class RecommendationFilter {
  ...
  List<PersonalizedRecommendation> apply(List<PersonalizedRecommendation> recommendations) {
    var filtered = recommendations;

    // Filter by interests
    if (interests.isNotEmpty) {
      filtered = filtered.where((r) =>
        r.metadata.matchedInterests.any((interest) => interests.contains(interest))
      ).toList();
    }
