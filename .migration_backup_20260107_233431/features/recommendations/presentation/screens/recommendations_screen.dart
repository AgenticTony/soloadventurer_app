...
import 'package:soloadventurer/features/auth/domain/providers/auth_providers.dart' show getCurrentUserProvider;
...
class _RecommendationsScreenState
  ...
  Widget _buildRecommendationsList(List<PersonalizedRecommendation> recommendations) {
