...
mixin _$AuthSession {
  ...
  int get hashCode => Object.hash(
      runtimeType, userId, accessToken, idToken, refreshToken, expiresAt);

  @override
  String toString() {
    return 'AuthSession(userId: $userId, accessToken: $accessToken, idToken: $idToken, refreshToken: $refreshToken, expiresAt: $expiresAt)';
  }
}
...
extension AuthSessionPatterns on AuthSession {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? userId, String accessToken, String idToken,
    ...
    switch (_that) {
      case _AuthSession() when $default != null:
        return $default(_that.userId, _that.accessToken, _that.idToken,
            _that.refreshToken, _that.expiresAt);
      case _:
        return orElse();
    }
  }
