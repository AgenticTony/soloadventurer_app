...
class ProfileLocalDataSourceImpl implements ProfileLocalDataSource {
  ...
  Future<Map<String, dynamic>?> getCachedPreferences(String userId) async {
    ...
    try {
      ...
      // Log JSON decode errors but return null for graceful degradation
      debugPrint('ProfileLocalDataSource.getCachedProfileData: JSON decode failed: $e');
  ...
  Future<List<String>?> getCachedInterests(String userId) async {
    ...
    try {
      ...
      // Log JSON decode errors but return null for graceful degradation
      debugPrint('ProfileLocalDataSource.getCachedInterests: JSON decode failed: $e');
      debugPrint('Stack trace: $stackTrace');
      return null;
    }
  }
