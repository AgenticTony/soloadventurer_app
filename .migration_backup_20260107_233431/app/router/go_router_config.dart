...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final requiresVerification = authState.value?.requiresEmailVerification ?? false;
      final requiresPasswordReset = authState.value?.requiresPasswordReset ?? false;
      ...
      if (isAuthenticated && isAuthRoute && !requiresVerification && !requiresPasswordReset) {
        return '/home';
      }
    ...
    routes: [
      ...
      GoRoute(
        path: '/',
        pageBuilder: (context, state) => const MaterialPage(child: AuthWrapper()),
      ),
      ...
      GoRoute(
        path: '/verify-email',
        pageBuilder: (context, state) => const MaterialPage(child: VerifyEmailScreen()),
      ),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => const MaterialPage(child: ConfirmPasswordResetScreen()),
      ),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          final isInitialSetup = state.uri.queryParameters['isInitialSetup'] == 'true';
          return MaterialPage(child: EditProfileScreen(isInitialSetup: isInitialSetup));
        },
      ),

      GoRoute(
        path: '/profile-settings',
        pageBuilder: (context, state) => const MaterialPage(child: ProfileSettingsScreen()),
      ),

      GoRoute(
        path: '/operation-queue',
        pageBuilder: (context, state) => const MaterialPage(child: OperationQueueScreen()),
      ),

      GoRoute(
        path: '/cloudwatch-test',
        pageBuilder: (context, state) => const MaterialPage(child: CloudWatchTestPage()),
      ),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return MaterialPage(
            child: ItineraryScreen(key: ValueKey(itineraryId), itineraryId: itineraryId),
          );
        },
      ),
      ...
      GoRoute(
        path: '/safety',
        pageBuilder: (context, state) => const MaterialPage(child: SafetyHubScreen()),
        routes: [
          // Trusted Contacts
          GoRoute(
            path: 'trusted-contacts',
            pageBuilder: (context, state) => const MaterialPage(child: TrustedContactsScreen()),
            routes: [
              GoRoute(
                path: 'add',
                pageBuilder: (context, state) => const MaterialPage(child: AddEditTrustedContactScreen()),
              ),
              GoRoute(
                path: 'edit',
                pageBuilder: (context, state) {
                  final contact = state.extra as TrustedContact?;
                  return MaterialPage(child: AddEditTrustedContactScreen(contact: contact));
                },
              ),
            ],
          ),
          ...
          GoRoute(
            path: 'check-ins',
            pageBuilder: (context, state) => const MaterialPage(child: CheckInHomeScreen()),
            routes: [
              GoRoute(
                path: 'manual',
                pageBuilder: (context, state) {
                  final existingCheckIn = state.extra as CheckIn?;
                  return MaterialPage(child: ManualCheckInScreen(existingCheckIn: existingCheckIn));
                },
              ),
              GoRoute(
                path: 'schedule',
                pageBuilder: (context, state) {
                  ...
                  return MaterialPage(child: ScheduleCheckInScreen(tripId: tripId));
                },
              ),
              GoRoute(
                path: 'history',
                pageBuilder: (context, state) => const MaterialPage(child: CheckInHistoryScreen()),
              ),
            ],
          ),
          ...
          GoRoute(
            path: 'emergency',
            pageBuilder: (context, state) => const MaterialPage(child: EmergencySOSScreen()),
          ),

          GoRoute(
            path: 'status-update',
            pageBuilder: (context, state) => const MaterialPage(child: StatusUpdateScreen()),
          ),

          // Location Sharing
          GoRoute(
            path: 'location-sharing',
            pageBuilder: (context, state) => const MaterialPage(child: LocationSharingScreen()),
          ),
        ],
      ),
        ...
        routes: [
          GoRoute(
            ...
            pageBuilder: (context, state) {
              ...
              return MaterialPage(child: StarterItineraryScreen(itinerary: itinerary));
            },
          ),
        ],
      ),
      ...
      GoRoute(
        path: '/settings/sync',
        pageBuilder: (context, state) => const MaterialPage(child: SyncSettingsScreen()),
      ),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => const MaterialPage(child: NotificationSettingsScreen()),
      ),
      GoRoute(
        path: '/notifications/history',
        pageBuilder: (context, state) => const MaterialPage(child: NotificationHistoryScreen()),
      ),
    ],

    // Error page for 404s
    errorPageBuilder: (context, state) => const MaterialPage(child: _NotFoundScreen()),
  );
});
