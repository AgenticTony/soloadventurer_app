...
typedef InterestSelectedCallback = void Function(
    TravelInterest interest, bool isSelected);
...
class TravelInterestChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FilterChip(
      ...
      disabledColor: theme.disabledColor.withValues(alpha: 0.1),
      ...
      labelStyle: theme.textTheme.bodyMedium?.copyWith(
        color:
            enabled ? foregroundColor : foregroundColor.withValues(alpha: 0.5),
