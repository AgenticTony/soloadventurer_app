...
class MediaCompression {
  ...
  Future<CompressedImageResult> _adjustQualityForTargetSize(
    ...
    Uint8List? compressed = await _doCompress(
      source,
      minWidth: config.maxWidth ?? 1920,
      minHeight: config.maxHeight ?? 1080,
      quality: quality,
  ...
  /// Compresses source using appropriate method (file or bytes)
  Future<Uint8List?> _doCompress(
    dynamic source, {
