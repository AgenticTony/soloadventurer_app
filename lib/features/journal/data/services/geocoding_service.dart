...
class GeocodingService {
  ...
  Future<List<GeocodingResult>> searchLocations(
    ...
    try {
      // Use geocoding package's locationFromAddress function
      ...
      throw const GeocodingException(
        message: 'Failed to search for locations. Please check your connection and try again.',
      );
    }
  }
  ...
  Future<GeocodingResult?> getAddressFromCoordinates(
    ...
    try {
      ...
      throw const GeocodingException(
        message: 'Failed to get address from coordinates. Please try again.',
      );
    }
  }
