...
sealed class ItineraryItem with _$ItineraryItem {
  ...
  String get displayName => map(
        ...
        flightDeparture: (item) =>
            'Flight Departure ${item.flightNumber ?? ''}',
  ...
  DateTime get time => when(
        flightArrival:
            (id, time, flightNumber, airportCode, note, isCompleted) => time,
        flightDeparture:
            (id, time, flightNumber, airportCode, note, isCompleted) => time,
        hotelCheckIn: (id, time, hotelName, address, confirmationNumber, note,
                isCompleted) =>
            time,
        hotelCheckOut: (id, time, hotelName, note, isCompleted) => time,
        activity: (id, time, name, description, location, durationHours, cost,
                bookingUrl, note, isCompleted) =>
            time,
        lunch: (id, time, name, cuisine, location, priceRange, note,
                isCompleted) =>
            time,
        dinner: (id, time, name, cuisine, location, priceRange, note,
                isCompleted) =>
            time,
      );
