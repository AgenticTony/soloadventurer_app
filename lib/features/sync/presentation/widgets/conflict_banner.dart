    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            highestSeverity.withOpacity(0.15),
            highestSeverity.withOpacity(0.05),
          ],
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: highestSeverity.withOpacity(0.5),
          width: 1,
        ),
      ),
      child: Row(
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(
              color: highestSeverity.withOpacity(0.2),
              borderRadius: BorderRadius.circular(8),
            ),
            child: Icon(
              Icons.warning_amber,
          ...
          Row(
            children: [
              ...
              FilledButton.tonal(
                onPressed: onViewAll,
                style: FilledButton.styleFrom(
                  backgroundColor: highestSeverity.withOpacity(0.2),
