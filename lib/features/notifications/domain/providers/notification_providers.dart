...
final getNotificationPreferencesProvider =
    Provider<GetNotificationPreferences>((ref) {
...
final updateNotificationPreferencesProvider =
    Provider<UpdateNotificationPreferences>((ref) {
...
final scheduleItineraryNotificationsProvider =
    Provider<ScheduleItineraryNotifications>((ref) {
